...
INSERT INTO games (title, price, discountprice) VALUES ('Bastion', 14.99, 8.88); 
...
INSERT INTO gamedetails (gid, gdesc, votes, artpath) VALUES (4, 'Analogue: A Hate Story is a visual novel created by independent designer and visual novelist Christine Love. It was created with the Ren''Py engine, and was first released for download on the author''s website in February 2012. A sequel set centuries after Love''s earlier work, Digital: A Love Story (2010), Analogue revolves around an unnamed investigator, who is tasked with discovering the reason for an interstellar ship''s disappearance once it reappears after 600 years. The game''s themes focus similarly around human/computer interaction, interpersonal relationships, and LGBT issues; but focus primarily on "transhumanism, traditional marriage, loneliness and cosplay."', 2, 'css/images/Analogue_A_Hate_Story.jpg');
...
INSERT INTO gamedetails (gid, gdesc, votes, artpath) VALUES (8, 'Limbo is a 2D sidescroller, incorporating the physics system Box2D to govern environmental objects and the player character. The player guides an unnamed boy through dangerous environments and traps as he searches for his sister. The developer built the game''s puzzles expecting the player to fail before finding the correct solution. Playdead called the style of play "trial and death", and used gruesome imagery for the boy''s deaths to steer the player from unworkable solutions.', 10, 'css/images/LIMBO.jpg');
...
INSERT INTO gamedetails (gid, gdesc, votes, artpath) VALUES (12, 'Explore a randomly generated Galaxy populated with factions, enemies, missions, and items providing you with a unique experience each time you play.', 5, 'css/images/SPAZ.jpg');
...
INSERT INTO gamedetails (gid, gdesc, votes, artpath) VALUES (15, 'Cloudbank is a hand-drawn, utopian-variant of Blade Runner’s neon-soaked future, and the battleground for robotic evil-doers the Process. Standing in their way is Red: a pop star swinging a giant green sword that talks.  That sword is the Transistor, which not only acts at the excellent narrator of the game, but is also the key mechanical component of the game’s battle system.  Transistor is an absolute mental work-out. Kill things in the wrong order and you can make things magnitudes worse for yourself.  A haunting, ethereal soundtrack accompanies the game.', 7, 'css/images/Transistor.jpg');
INSERT INTO gamedetails (gid, gdesc, artpath) VALUES (16, 'Bastion is the first title from Supergiant Games, an original action role-playing game set in a lush imaginative world, in which players must create and fight for civilization''s last refuge as a mysterious narrator marks their every move.  Something called the "Great Calamity" has rolled in and taken out your entire civilization. You awaken as "the Kid," and set off to restore the Bastion -- a spot where everyone was supposed to meet if bad stuff went down. To do this, you''ll need to dive into levels, best foes, and collect shards. The graphics are amazing; the scenes are like watercolor paintings with stained glass influences.  Toss in some fantastic music and sound effects, and Bastion is a blast to experience.', 'css/images/Bastion_Boxart.jpg');
...
INSERT INTO comments (userid, month, day, year, color, comment) VALUES (3, 'Mar', 2, 2016, 'orange', 'Portal is so mindbending; I have to vote for LIMBO.'); 
INSERT INTO comments (userid, month, day, year, color, comment) VALUES (2, 'Mar', 11, 2016, 'blue', 'Can''t wait to get SPAZ!'); 
INSERT INTO comments (userid, month, day, year, color, comment) VALUES (1, 'Mar', 15, 2016, 'limegreen', 'You forget.  System user always wins.');

GRANT SELECT ON comments to limited;
GRANT INSERT ON comments to limited;
GRANT USAGE ON comments_commentid_seq to limited;
